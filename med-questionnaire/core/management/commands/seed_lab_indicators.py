...
RISK_LAB_INDICATORS = [
    ...
    ("ast", "AST (aspartate aminotransferase)", "AST", "hepatic", "U/L", None, 40.0),
    ("total_cholesterol", "Total cholesterol", "Total cholesterol", "cardiovascular", "mmol/L", None, 5.0),
    ("albumin", "Albumin", "Albumin", "other", "g/L", 35.0, 52.0),
