...
urlpatterns = [
    ...
    path("login/verify-code/", LoginVerifyCodeAPIView.as_view(), name="auth_login_verify_code"),
    path("patient-login/verify-code/", LoginVerifyCodeAPIView.as_view(), name="auth_patient_login_verify_code"),
